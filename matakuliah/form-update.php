<?php
  ...
  $query = "SELECT kode, nama_matkul, sks, semeseter, id_dosen, nama_dosen
  ...
  <form  action="update.php" method="post">
    <table>
      ...
      <tr>
        ...
        <td> <input type="text" name="sks" id="sks" value="<?php echo $data_dosen['sks']; ?>"> </td>
      </tr>
      <tr>
        <td><label for="semester">Semester</label></td> <td> : </td>
        <td> <input type="text" name="semester" id="semester" value="<?php echo $data_dosen['semeseter']; ?>"> </td>
      </tr>
      <tr>
